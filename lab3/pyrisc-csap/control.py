...
csignals = {
    ...
    # SVUNPACK : not use rs2 --> OP2_X, OEN_0
    # SVPACK : use rs1, rs2 --> OP1_RS1, OP2_RS2, OEN_1, OEN_1
    # SVBRDCST : use rs1 --> OP1_RS1, OP2_X, OEN_1, OEN_0
    # SVADDI : use imm12 instead of rs2 --> OP2_IMI, OEN_0
    # SVADD : use rs1, rs2 --> OP1_RS1, OP2_RS2, OEN_1, OEN_1
    # SVSUB : use rs1, rs2 --> OP1_RS1, OP2_RS2, OEN_1, OEN_1
    # SVMUL : use rs1, rs2 --> OP1_RS1, OP2_RS2, OEN_1, OEN_1
