...
# Custom extensions (vector operations)
# Express 0 ~ f to 4 binary bits --> all 32 bits
SVUNPACK_MASK   = WORD(0b11111111111100000111000001111111) 
SVPACK_MASK     = WORD(0b11111110000000000111000001111111)
SVBRDCST_MASK   = WORD(0b11111111111100000111000001111111)
SVADDI_MASK     = WORD(0b00000000000000000111000001111111)
SVADD_MASK      = WORD(0b11111110000000000111000001111111)
SVSUB_MASK      = WORD(0b11111110000000000111000001111111)
SVMUL_MASK      = WORD(0b11111110000000000111000001111111)
